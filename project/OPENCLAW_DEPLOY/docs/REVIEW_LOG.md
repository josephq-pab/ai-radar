...
**验收标准**：
- 4 份文档已写入 docs/ ✅
- 十页完成模板实例化属性落地 ✅（data-template + data-role + data-stop-type + data-phase）
- 十页完成 data-template 标识 ✅
- 至少 6 个共性 block 完成 data-block 标识 ✅（meta/first-screen/governance-fold/footer-nav = 4 per page × 10）
- 支援页完成 4 个高优先级组件试点 ✅（glossary/registry/config-status/routes + data-pilot）
- 试点页面语义与 Phase 4 冻结基线一致，无回退 ✅
- footer / meta / 版本体系继续保持一致 ✅
- STAGE2 / FEEDBACK / REVIEW_LOG / CHANGE_CONTROL 同步 ✅
...
- 十页 HTML（body data-* 属性 + Block 注释标注 + 支援页 data-pilot 标注）

**PHASE5-3 建议方向**：
- 四个支援页从试点标注推进到实际组件片段提取
- single-chain-ops 试点 FirstScreenJudge + GovernanceFold
- 建立四个高优先级组件的标准 HTML 模板片段
